...
import { Award } from './activityStore'
import './awardUnlockModal.css';

interface AwardUnlockModalProps {
    award: Award;
}

type AppearanceStage = 'preAppear' | 'appear' | 'disappear';

const AwardUnlockModal: React.FC<AwardUnlockModalProps> = ({ award }) => {
    const [stage, setStage] = React.useState('preAppear' as AppearanceStage);
    const rootClass = `AwardUnlockModal stage-${stage}`;
    return (
...
export default AwardUnlockModal
